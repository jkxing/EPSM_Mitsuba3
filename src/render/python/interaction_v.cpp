...
MI_PY_EXPORT(SurfaceInteraction) {
    ...
    auto si =
        ...
        .def_field(SurfaceInteraction3f, p0,         D(SurfaceInteraction, p0))
        .def_field(SurfaceInteraction3f, p1,         D(SurfaceInteraction, p1))
        .def_field(SurfaceInteraction3f, p2,         D(SurfaceInteraction, p2))
        .def_field(SurfaceInteraction3f, b0,         D(SurfaceInteraction, b0))
        .def_field(SurfaceInteraction3f, b1,         D(SurfaceInteraction, b1))
        .def_field(SurfaceInteraction3f, ismesh,         D(SurfaceInteraction, ismesh))
        .def_field(SurfaceInteraction3f, n0,         D(SurfaceInteraction, n0))
        .def_field(SurfaceInteraction3f, n1,         D(SurfaceInteraction, n1))
        .def_field(SurfaceInteraction3f, n2,         D(SurfaceInteraction, n2))
