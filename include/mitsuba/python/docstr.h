...
static const char *__doc_mitsuba_BSDFSample3_hf = R"doc(halfvector)doc";
...
static const char *__doc_mitsuba_SurfaceInteraction_p0 = R"doc(Position partials wrt. the UV parameterization)doc";
static const char *__doc_mitsuba_SurfaceInteraction_p1 = R"doc(Position partials wrt. the UV parameterization)doc";
static const char *__doc_mitsuba_SurfaceInteraction_p2 = R"doc(Position partials wrt. the UV parameterization)doc";
static const char *__doc_mitsuba_SurfaceInteraction_n0 = R"doc(Position partials wrt. the UV parameterization)doc";
static const char *__doc_mitsuba_SurfaceInteraction_n1 = R"doc(Position partials wrt. the UV parameterization)doc";
static const char *__doc_mitsuba_SurfaceInteraction_n2 = R"doc(Position partials wrt. the UV parameterization)doc";
static const char *__doc_mitsuba_SurfaceInteraction_b0 = R"doc(Position partials wrt. the UV parameterization)doc";
static const char *__doc_mitsuba_SurfaceInteraction_b1 = R"doc(Position partials wrt. the UV parameterization)doc";
static const char *__doc_mitsuba_SurfaceInteraction_ismesh = R"doc(Position partials wrt. the UV parameterization)doc";
