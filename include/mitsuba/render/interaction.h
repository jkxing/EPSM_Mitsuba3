...
struct SurfaceInteraction : Interaction<Float_, Spectrum_> {
    ...
    //modify for epsm, record point, normal, uv coord and geometry type.
    Point3f p0,p1,p2;
    Vector3f n0,n1,n2;
    Float b0,b1,ismesh;
    ...
    explicit SurfaceInteraction(const PositionSample3f &ps,
        ...
        : Base(0.f, ps.time, wavelengths, ps.p, ps.n), uv(ps.uv),
          ...
          duv_dx(0), duv_dy(0), wi(0), prim_index(0), boundary_test(0),p0(0),p1(0),p2(0),n0(0),n1(0),n2(0),b1(0),b0(0){}
    ...
    void initialize_sh_frame() {
        ...
        //sh_frame.s = dr::detach<true>(sh_frame.s);
    ...
    DRJIT_STRUCT(SurfaceInteraction, t, time, wavelengths, p, n, shape, uv,
                 ...
                 duv_dy, wi, prim_index, instance, boundary_test,p0,p1,p2,b0,b1,ismesh,n0,n1,n2)
};
